            ...
            <form action="<?=base_url() ?>games/store" method="post">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" rows="5" class="form-control" required ><?= isset($game) ? $game['description'] : "" ?>
                    </textarea>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="release_date" id="release_date"
                            placeholder="Release Date" value="<?= isset($game) ? $game['release_date'] : "" ?>" required>
                    </div>
                </div>
